...
export const orbRegistry: OrbRegistryEntry[] = [
  ...
  },
  {
    ...
    title: "ORBSY-01",
    description:
      "Halftone. A lit, noise-streaked sphere printed through a rotated dot screen: each screen cell samples the ball once at its centre and draws one dot whose area follows that tone, so the orb reads as a print rather than a render. The screen coarsens and the dots swell with the voice.",
    componentName: "Orbsy01",
    fileName: "orbsy-01.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-02",
    title: "ORBSY-02",
    description:
      "Chrome. A liquid-metal blob: a sphere SDF displaced by interfering sines, sphere traced and shaded purely by reflecting a procedural studio of sky, horizon line, softboxes and a sun, with a fresnel-driven thin film adding oily iridescence at grazing angles.",
    componentName: "Orbsy02",
    fileName: "orbsy-02.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-03",
    title: "ORBSY-03",
    description:
      "Aurora. The soft gradient orb of voice-assistant UIs: three coloured blobs orbit inside a glassy ball, layered painter-style over a base colour and sampled through an fbm domain warp so the colours smear like liquid, finished with sphere shading, a rim light and one specular highlight.",
    componentName: "Orbsy03",
    fileName: "orbsy-03.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-04",
    title: "ORBSY-04",
    description:
      "Contour. A topographic map wrapped on a slowly turning globe: isolines of a 3D fbm height field drawn at a constant pixel width by dividing distance-to-contour by the field's measured screen-space gradient, with every fifth line an index contour drawn heavier.",
    componentName: "Orbsy04",
    fileName: "orbsy-04.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-05",
    title: "ORBSY-05",
    description:
      "Pixel. A low-res sprite of a sphere: square blocks each sample the lit, noise-streaked ball once and snap it to a four-colour ramp, while rows slip sideways on a stepped glitch clock and single blocks flash hot, more often when the orb is busy or hearing input.",
    componentName: "Orbsy05",
    fileName: "orbsy-05.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-06",
    title: "ORBSY-06",
    description:
      "Iris. An eye that watches the conversation: radial fibres are fbm sampled on the unit circle so the angle wraps without a seam, finished with a collarette ring, a dark limbal ring and a glowing pupil edge. The pupil narrows to think and dilates with the agent's voice.",
    componentName: "Orbsy06",
    fileName: "orbsy-06.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-07",
    title: "ORBSY-07",
    description:
      "Waveform. Stacked signal traces clipped to a disc, in the spirit of a pulsar plot: each line is a chord of the circle displaced by two octaves of noise under an envelope that vanishes at the chord's ends, driven by the agent's output volume so the ball visibly talks.",
    componentName: "Orbsy07",
    fileName: "orbsy-07.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-08",
    title: "ORBSY-08",
    description:
      "Nebula. A pocket galaxy: two-level domain-warped 3D fbm on the sphere's normal swirls gas in three colours, a hashed 3D cell grid scatters twinkling stars through it, and limb darkening, a rim and an outer halo make the ball read as a glowing volume.",
    componentName: "Orbsy08",
    fileName: "orbsy-08.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-09",
    title: "ORBSY-09",
    description:
      "Lattice. A particle globe: dots laid out in latitude rings whose count follows cos(latitude), so spacing stays even from equator to pole, with each pixel finding its nearest dot analytically. Dot size follows a blend of noise and a travelling latitude wave, so energy ripples across the surface.",
    componentName: "Orbsy09",
    fileName: "orbsy-09.tsx",
    dependencies: []
  },
  {
    slug: "orbsy-10",
    title: "ORBSY-10",
    description:
      "Bubble. A soap bubble: film thickness is a swirling fbm field plus a drainage term that pools film toward the bottom, colour comes from thin-film interference along the optical path, and Schlick fresnel keeps the face nearly clear and the rim bright.",
