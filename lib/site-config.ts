...
export const REGISTRY_NAMESPACE = "orbsy";

/** Human-facing product name. */
export const SITE_NAME = "Orbsy";
...
export const SITE_DESCRIPTION =
  "Orbsy is a React component library of WebGL shader orbs for AI and voice agent states, built on Orbkit by zzzzshawn and installed as local code through the shadcn registry. Free for non-commercial use with attribution; the runtime and original orbs are MIT.";

export const CREATOR_NAME = "zzzzshawn";
export const CREATOR_URL = "https://x.com/zzzzshawn/";

/** Public source repository. */
export const REPO_URL = "https://github.com/m3tamode/Orbsy";
